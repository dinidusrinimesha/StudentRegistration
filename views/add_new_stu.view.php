                ...
                <div class="modal-body text-start">
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Sunil" required>
                        </div>
                        <div class="col-lg-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="sunil@sample.com" required>
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label for="contact_no" class="form-label"><span class="text-danger">* </span>Contact Number</label>
                            <input type="text" class="form-control" id="contact_no" name="contact_no" placeholder="07X X XXXXXX" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control mb-1" id="address_line_1" name="address_line_1" placeholder="Address Line 1" required>
